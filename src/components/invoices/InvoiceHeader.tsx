...
export default function InvoiceHeader({ title = "FACTURE" }: InvoiceHeaderProps) {
  return (
    <div className="bg-gradient-to-r from-indigo-600 to-purple-600 rounded-2xl shadow-lg overflow-hidden mb-6">
